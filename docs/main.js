(function (global, factory) {
  ...
  var uploadImage = function (file) {
      ...
      return fetch("https://apipond.com/image_uploads", {
          ...
          .then(function (json) { return json.upload_id; });
  };
  function DemoComponent() {
      var _a = React.useState(null), imageId = _a[0], setImageId = _a[1];
      return React__default.createElement("div", null,
          React__default.createElement(Reimagine, { width: 200, height: 200, onSelectImage: function (file) { return uploadImage(file).then(function (id) {
                  setImageId(id);
              }); }, onEdit: saveImageEdit.bind(null, imageId) }));
  }
  ReactDOM.render(React__default.createElement(DemoComponent, null), document.getElementById("root"));

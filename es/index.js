...
function DeleteIcon() {
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "100%" },
...
function CanvasImageWindow(_a) {
    ...
    var windowEl = useRef(null);
    var _b = useState(null), imageManager = _b[0], setImageManager = _b[1];
    var _c = useState(false), _imageLoaded = _c[0], setImageLoaded = _c[1];
    var _d = useState(0), scale = _d[0], setScale = _d[1];
    useEffect(function () {
        if (!imageEl.current) {
            return;
        }
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { ref: windowEl, className: "image-window", style: {
                width: width + "px",
                height: height + "px"
            ...
            React.createElement("canvas", { ref: imageEl, width: width, height: height }, "Fallback")),
        React.createElement("input", { className: "scale-slider", type: "range", min: imageManager ? imageManager.getMinScale() * 100 : 0, max: 100, value: scale, onMouseDown: function (e) {
                if (!imageManager) {
                    return;
                }
        ...
        React.createElement("button", { className: "action-button", style: { left: 0 }, onClick: function () { return clearImage(); } },
            React.createElement(DeleteIcon, null)),
        React.createElement("button", { className: "action-button", style: { right: 0 }, onClick: function () {
                if (!imageManager) {
                    return;
                }
...
function ImagePreview(_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("button", { className: "action-button", style: { right: 0 }, onClick: function () { return startEditing(); } },
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("img", { src: imageSource, draggable: false, style: {
                    position: "absolute",
...
function Reimagine(_a) {
    ...
    var _b = useState(null), imageSource = _b[0], setImageSource = _b[1];
    var _c = useState(true), isEditing = _c[0], setIsEditing = _c[1];
    var _d = useState(null), imageDimensions = _d[0], setImageDimensions = _d[1];
    if (!isEditing && imageSource !== null && imageDimensions !== null) {
        return (React.createElement(ImagePreview, { imageSource: imageSource, width: width, height: height, imageDimensions: imageDimensions, startEditing: function () { return setIsEditing(true); } }));
    }
    if (imageSource === null) {
        return (React.createElement("div", null,
            React.createElement(ImageUploader, { setImageSource: function (source) {
                    setImageSource(createFileURL(source));
                    onSelectImage(source);
                }, width: width, height: height })));
    }
    return (React.createElement("div", null,
        React.createElement(CanvasImageWindow, { width: width, height: height, imageSource: imageSource, clearImage: function () {
                setImageSource(null);
